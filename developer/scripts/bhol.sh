...
git config --global user.email "marc.wurm@hotmail.com"
git config --global user.name "Gordon420"

cp -R ~/MCW-Cloud-native-applications/Hands-on\ lab/lab-files/developer ~/Fabmedical
cd ~/Fabmedical
git init
git remote add origin https://github.com/Gordon420/Fabmedical.git
...
cd ~/Fabmedical
sed -i "s/\[739736\]/739736/g" ~/Fabmedical/.github/workflows/content-init.yml
sed -i "s/\[739736\]/739736/g" ~/Fabmedical/.github/workflows/content-api.yml
sed -i "s/\[739736\]/739736/g" ~/Fabmedical/.github/workflows/content-web.yml
...
ACR_CREDENTIALS=$(az acr credential show -n fabmedical739736)
